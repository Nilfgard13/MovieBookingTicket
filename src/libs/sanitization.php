...
* @return array
*/
function sanitize(array $inputs, array $fields = [], int $default_filter = FILTER_SANITIZE_EMAIL, array $filters = FILTERS, bool $trim = true): array
{
    if ($fields) {
