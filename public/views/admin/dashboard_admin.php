                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title text-center">Get Films | User Dashboard</h4><br>
                                    <?php if ($user['is_admin'] == 0) { ?>
                                        <div class="row">
                                            <!-- Profile Section -->
                                            <div class="col-lg-3">
                                                <img src="../../../app/assets/images/profile/user-general.png" alt="default-profile-image" class="img-fluid"><br>
                                            ...
                                            <!-- Welcoming Section -->
                                            <div class="col-lg-9">
                                                <p>Welcome, <?php echo htmlspecialchars($user['username']); ?>! Here you can find films curated just for you.</p>
                                    ...
                                    <?php } elseif ($user['is_admin'] == 1) { ?>
                                        <div class="row">
                                            <!-- Admin Section -->
                                            <div class="col-lg-12">
                                                <h5 class="text-center">Welcome, Admin <?php echo htmlspecialchars($user['username']); ?>!</h5>
